				...
				<div className='md:ml-[210px] w-full'>
					<div className='flex flex-col gap-16 max-w-7xl mx-auto'>
						...
						<div className='informativeText'>
							<ul>
								<li>
									2015 - Ganadores del concurso “Misiones
									Diseña” de la Subsecretaría de Cultura de
									la Provincia de Misiones.
								</li>
								<li>
									2018 - Premio “Diseño Sustentable” de la
									Feria de Artesanías del Mercosur (FAM)
								</li>
								<li>
								...
								<li>
									2019 - Ganadores “Concurso Nacional
									Potenciar” del Ministerio de Desarrollo
									Social de la Nación.
								</li>
								<li>
								...
								<li>
									Muestra artística individual en el Museo
									Yaparí (2019) Museo Gastòn Dachary (2020)
								</li>
								<li>
									espacio Multicultural de la Costanera de
									Posadas (2022)
								</li>
								<li>
									2021/2022 - Beneficiarios “MANTA” programa
									de la Secretaría de Desarrollo Cultural y
									el Mercado de Artesanías Tradicionales e
									Innovadoras Argentinas.
								</li>
								<li>
									Representantes de Misiones en la Feria
									&quot;Puro Diseño&quot; de la Rural de Bs
									As.
								</li>
							</ul>
						</div>
