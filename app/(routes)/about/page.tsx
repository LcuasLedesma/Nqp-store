const About = () => {
	return (
		...
		// 					Diseña” de la Subsecretaría de Cultura de la
		...
		// 				</li>
		// 				<li>
		// 					2021/2022 - Beneficiarios “MANTA” programa de
		// 					la Secretaría de Desarrollo Cultural y el
		// 					Mercado de Artesanías Tradicionales e
